...
PH2.get.cc.uc.appr <- function(ARL0, k, nu = k - 1, c4.option = TRUE){
	...
	c - ( (dnorm(c) / 2 / (1 - pnorm(c)) - c / 2) * (A + 1/k) + dnorm(c) / 2 / (1 - pnorm(c)) * (A - 1/k) )
...
############################################################################################################################################
	#This main function need to be capable to the approximations for both of UC and EPC
############################################################################################################################################
